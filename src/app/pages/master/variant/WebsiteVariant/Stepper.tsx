...
interface StepperProps {
  ...
  isEditMode?: boolean; // ✅ NEW: when true, all steps are checked + clickable
}
      ...
      <div className="min-w-175 px-4 py-2">
        <div className="relative flex items-start justify-between gap-3">
          ...
          {steps.map((step, i) => {
            ...
            const leftSiblingStepKey = getLeftSiblingStep(
              step.key,
              stepKeys,
            );

            // ✅ Edit mode: every step directly clickable/navigable
            // Normal (create) mode: old sequential logic as-is
              ...
              >
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    isClickable && currentStep !== i && "cursor-pointer",
                    !isClickable && "cursor-not-allowed",
                  )}
                >
                  {isDone ? <HiCheck className="h-4 w-4" /> : i + 1}
                </button>
